...
<div class="header">
	<ul class="nav">
		...
		<li> <a class="active" href="fechain.php">Movimientos</a> </li>
 ...
 <?php
	...
	{	
		...
		$consulta="SELECT * FROM cuenta WHERE id_usuario = '$var_inter' AND Fecha >'$fecha_inicio' AND Fecha <'$fecha_fin';";
		...
		echo "<tr><th>Fecha</th><th>Concepto</th><th>Ingresos</th><th>Gastos</th><th>Saldo</th></tr>";
		...
		{			
			...
			echo "<td>" . $resultado_traducido['Ingresos'] . "&euro;</td>";
			
			echo "<td>" . $resultado_traducido['Gastos'] . "&euro;</td>";

			echo "<td>" . $resultado_traducido['Saldo'] . "&euro;</td></tr>";
	...
	}else
	{
		...
		echo "<form method='post' action='fechain.php' name='fechain'>";

		echo "Fecha inicio: <br> <input type='date' name='fecha_desde'><br><br>";
		
		echo "Fecha Fin: <br> <input type='date' name='fecha_hasta'><br><br>";
					
		echo "Nota: Formato de fecha: 2016-03-27 <br><br>";
