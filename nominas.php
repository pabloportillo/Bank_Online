...
<div class="header">
	<ul class="nav">
		...
		<li> <a class="active" href="nominas.php">Nominas</a> </li>
 ...
 <?php
		...
		$consulta="SELECT * FROM cuenta WHERE id_usuario = '$var_inter' AND Concepto='Nomina';";
		...
		{			
			...
			echo "<td>" . $resultado_traducido['Ingresos'] . "&euro;</td></tr>";					
		}
		echo "</table></div>";
